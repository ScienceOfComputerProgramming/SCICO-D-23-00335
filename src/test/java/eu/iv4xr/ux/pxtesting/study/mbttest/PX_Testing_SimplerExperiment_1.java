...
import eu.iv4xr.ux.pxtesting.study.Pipeline.TestSettings;
    ...
    public void runPXEvaluation(String button_doors1_setup) throws InterruptedException, IOException {
        ...
        try {
            ...
            var testAgent = new LabRecruitsTestAgent("agent1") // matches the ID in the CSV file
                    .attachState(new BeliefState()).attachEnvironment(environment).attachSyntheticEventsProducer(new EventsProducer());
